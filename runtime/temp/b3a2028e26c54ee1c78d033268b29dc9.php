<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"E:\phpstudy\WWW\jobmana\public/../application/admin\view\companyman\edit.html";i:1533878062;s:75:"E:\phpstudy\WWW\jobmana\public/../application/admin\view\template\base.html";i:1533694440;s:86:"E:\phpstudy\WWW\jobmana\public/../application/admin\view\template\javascript_vars.html";i:1533694438;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    <form class="form form-horizontal" id="form" method="post" action="<?php echo \think\Request::instance()->baseUrl(); ?>">
        ...
        <div class="row cl">
            ...
            <textarea class="textarea" placeholder="企业简介" name="comdesc" onKeyUp="textarealength(this, 100)"><?php echo isset($vo['comdesc']) ? $vo['comdesc'] :  ''; ?></textarea>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <!-- <input type="text" class="input-text" placeholder="营业执照" name="comlicense" value="<?php echo isset($vo['comlicense']) ? $vo['comlicense'] :  ''; ?>" > -->
                 <input type="text" class="input-text" id="comlicense" name="comlicense" value="<?php echo isset($vo['comlicense']) ? $vo['comlicense'] :  ''; ?>" placeholder="营业执照" style="width: 70%">
            <button type="button" class="btn btn-primary radius" onclick="layer_open('文件上传','<?php echo \think\Url::build('Upload/index', ['id' => 'comlicense']); ?>')">上传</button>
             <a onclick="$(this).attr('href', $('#comlicense').val())" type="button" class="btn btn-success radius" data-lightbox="preview">预览</a>
            </div>
            <div class="col-xs-3 col-sm-3"></div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <!-- <input type="text" class="input-text" placeholder="税务登记证" name="comtaxreg" value="<?php echo isset($vo['comtaxreg']) ? $vo['comtaxreg'] :  ''; ?>" > -->
                  <input type="text" class="input-text" id="comtaxreg"  placeholder="税务登记证" name="comtaxreg" value="<?php echo isset($vo['comtaxreg']) ? $vo['comtaxreg'] :  ''; ?>"  style="width: 70%">
            <button type="button" class="btn btn-primary radius" onclick="layer_open('文件上传','<?php echo \think\Url::build('Upload/index', ['id' => 'comtaxreg']); ?>')">上传</button>
             <a onclick="$(this).attr('href', $('#comtaxreg').val())" type="button" class="btn btn-success radius" data-lightbox="preview">预览</a>
            </div>
            <div class="col-xs-3 col-sm-3"></div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                ...
                <input type="text" class="input-text" id="comlogo" name="comlogo" value="<?php echo isset($vo['comlogo']) ? $vo['comlogo'] :  ''; ?>" placeholder="企业logo" style="width: 70%">
            <button type="button" class="btn btn-primary radius" onclick="layer_open('文件上传','<?php echo \think\Url::build('Upload/index', ['id' => 'comlogo']); ?>')">上传</button>
              <a onclick="$(this).attr('href', $('#comlogo').val())" type="button" class="btn btn-success radius" data-lightbox="preview">预览</a>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <!-- <input type="text" class="input-text" placeholder="企业照片" name="comthumb" value="<?php echo isset($vo['comthumb']) ? $vo['comthumb'] :  ''; ?>" > -->
                 <input type="text" class="input-text" id="comthumb" name="comthumb" placeholder="企业照片"  style="width: 70%" value="<?php echo isset($vo['comthumb']) ? $vo['comthumb'] :  ''; ?>">
            <button type="button" class="btn btn-primary radius" onclick="layer_open('文件上传','<?php echo \think\Url::build('Upload/index', ['id' => 'comthumb']); ?>')">上传</button>
               <a onclick="$(this).attr('href', $('#comthumb').val())" type="button" class="btn btn-success radius" data-lightbox="preview">预览</a>
