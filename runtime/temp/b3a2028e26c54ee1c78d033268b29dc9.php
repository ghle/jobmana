...
<div class="page-container">
    <form class="form form-horizontal" id="form" method="post" action="<?php echo \think\Request::instance()->baseUrl(); ?>">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
               <!--  <input type="text" class="input-text" placeholder="是否审核通过" name="comtfpass" value="<?php echo isset($vo['comtfpass']) ? $vo['comtfpass'] :  '请选择'; ?>" > -->
                <div class="select-box">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <!-- <input type="text" class="input-text" placeholder="是否展示照片" name="comtfthumb" value="<?php echo isset($vo['comtfthumb']) ? $vo['comtfthumb'] :  '请选择'; ?>" > -->
                 <div class="select-box">
